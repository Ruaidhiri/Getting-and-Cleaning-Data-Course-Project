...
write.table(tidy.data, "./UCI HAR Dataset/tidy-data.txt", row.name=FALSE)
...
write.table(tidy.data.averages, "./UCI HAR Dataset/tidy-data-averages.txt", row.name=FALSE)